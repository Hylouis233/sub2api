...
func TestImportDataReusesProxyAndSkipsDefaultGroup(t *testing.T) {
	...
	require.False(t, adminSvc.createdAccounts[0].AutoBindProxy)
	require.True(t, adminSvc.createdAccounts[0].SkipDefaultGroupBind)
}

func TestImportDataDefaultsToDefaultGroupAndAutoProxy(t *testing.T) {
	router, adminSvc := setupAccountDataRouter()
	...
	require.True(t, adminSvc.createdAccounts[0].AutoBindProxy)
