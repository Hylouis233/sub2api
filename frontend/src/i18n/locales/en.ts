export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      subscriptionQualityPolicyHint: 'Quality filtering runs live network probes for each newly created proxy. Keep it off for large imports unless you want the import request to wait for checks.',
      ...
      subscriptionQualityNone: 'Do not run quality checks',
