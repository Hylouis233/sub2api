export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          accessTokenDesc: 'Enter OpenAI accessToken values. Supports batch input (one per line). Without refresh_token, expiry follows the accessToken expiry.',
          accessTokenInputLabel: 'Access Token',
          accessTokenPlaceholder: 'Paste OpenAI accessToken...\nSupports multiple, one per line',
          accessTokenHint: 'Use this for temporary AT import. Prefer RT or Codex JSON when automatic refresh is required.',
          accessTokenImportAndSave: 'Import & Save',
          singleReauthInputRequired: 'Existing account re-authorization accepts exactly one {label} at a time',
          ...
          codexSessionImportAndCreate: 'Import & Save',
    ...
    proxies: {
      ...
      subscriptionSupportedHint: 'Only http, https, socks5, and socks5h nodes are imported. SS/VLESS/Hysteria/Trojan nodes are skipped.',
      ...
      subscriptionImportSuccess: 'Subscription import completed: created {created}, skipped {skipped}, unsupported {unsupported}',
      subscriptionImportPartial: 'Subscription import completed with issues: created {created}, skipped {skipped}, unsupported {unsupported}, invalid {invalid}, failed {failed}',
